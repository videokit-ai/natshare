...
namespace NatShare.Internal {
    ...
    public static class PayloadBridge {
        ...
        [DllImport(Assembly, EntryPoint = @"NSDispose")]
        public static extern void Dispose (this IntPtr payload);
        ...
        public static extern void AddImage (this IntPtr payload, byte[] pixelBuffer, int width, int height);
        ...
        public static void Dispose (this IntPtr payload) { }
